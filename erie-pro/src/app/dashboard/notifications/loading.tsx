        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="flex items-center justify-between py-3">
            <div className="space-y-1.5">
              ...
              <div className="h-3 w-48 animate-pulse motion-reduce:animate-none rounded bg-muted" />
            </div>
            <div className="h-6 w-11 animate-pulse motion-reduce:animate-none rounded-full bg-muted" />
          </div>
        ))}
      </div>
    </div>
