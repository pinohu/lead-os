...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/lead-sla", label: "Lead SLA", icon: "⏱️" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/revenue-stack", label: "Tool Stack", icon: "🧩" },
      { href: "/admin/offers", label: "Automated Offers", icon: "🛒" },
      { href: "/admin/provider-offers", label: "Provider Offers", icon: "🏛️" },
      { href: "/admin/thrivecart-events", label: "ThriveCart Queue", icon: "🧾" },
