    ...
    <div>
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-1">
          <span className="px-2 text-xs text-gray-500 dark:text-gray-400">Outcome:</span>
          <Link
        ...
        {/* Niche filter */}
        <div className="flex items-center gap-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-1">
          <span className="px-2 text-xs text-gray-500 dark:text-gray-400">Niche:</span>
          <Link
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium capitalize ${
                            OUTCOME_COLORS[call.outcome] ?? "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400"
                          }`}
                        >
                          {call.outcome}
                        </span>
