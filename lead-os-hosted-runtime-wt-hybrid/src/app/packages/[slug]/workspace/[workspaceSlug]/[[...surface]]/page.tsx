...
export default async function PackageWorkspacePage({ params, searchParams }: Props) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      {activeSurface === "reporting" ? <ReportingSurface /> : null}
...
function surfaceHref(slug: string, workspaceSlug: string, surface: string, query: Record<string, string | string[] | undefined>): string {
  ...
  for (const key of ["brand", "market", "offer"]) {
  ...
  return (
    <section className="rounded-lg border border-primary/25 bg-primary/5 p-5">
      ...
      <form className="mt-5 grid gap-3 md:grid-cols-2">
        <input className="min-h-11 rounded-md border border-input bg-background px-3" placeholder="First name" />
        <input className="min-h-11 rounded-md border border-input bg-background px-3" placeholder="Last name" />
        <input className="min-h-11 rounded-md border border-input bg-background px-3" placeholder="Email" />
        <input className="min-h-11 rounded-md border border-input bg-background px-3" placeholder="Phone" />
        <textarea className="min-h-24 rounded-md border border-input bg-background px-3 py-2 md:col-span-2" placeholder="What outcome do you want?" />
