...
const DEMO_TENANTS: TenantRecord[] = [
  { tenantId: "t-acme-roofing", slug: "acme-roofing", brandName: "Acme Roofing Co.", siteUrl: "https://acme-roofing.example.com", supportEmail: "support@acme-roofing.com", defaultNiche: "roofing", accent: "#f97316", enabledFunnels: ["lead-magnet", "qualification", "chat"], channels: { email: true, sms: true, whatsapp: false }, revenueModel: "lead-sale", plan: "whitelabel-growth", status: "active", operatorEmails: ["ops@acme-roofing.com"], createdAt: "2026-01-15T09:00:00Z" },
  { tenantId: "t-swift-hvac", slug: "swift-hvac", brandName: "Swift HVAC", siteUrl: "https://swift-hvac.example.com", supportEmail: "hello@swifthvac.io", defaultNiche: "hvac", accent: "#3b82f6", enabledFunnels: ["lead-magnet", "qualification", "webinar"], channels: { email: true, sms: true, whatsapp: true }, revenueModel: "retainer", plan: "whitelabel-enterprise", status: "active", operatorEmails: ["admin@swifthvac.io"], createdAt: "2026-02-01T09:00:00Z" },
  { tenantId: "t-green-lawn", slug: "green-lawn", brandName: "Green Lawn Erie", siteUrl: "https://green-lawn.example.com", supportEmail: "info@greenlawn.com", defaultNiche: "landscaping", accent: "#22c55e", enabledFunnels: ["lead-magnet", "chat"], channels: { email: true, sms: false, whatsapp: false }, revenueModel: "lead-sale", plan: "whitelabel-starter", status: "provisioning", operatorEmails: [], createdAt: "2026-03-20T09:00:00Z" },
];
