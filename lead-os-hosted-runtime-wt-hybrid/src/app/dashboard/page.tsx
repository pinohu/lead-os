      ...
      <section className="grid gap-8 lg:grid-cols-3" aria-labelledby="dashboard-heading">
        <div className="lg:col-span-2 space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Lead OS is optimizing for milestone two and milestone three, not just the first capture
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Card className="bg-muted/30">
                <CardContent className="pt-4 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">n8n and internal workflow emissions logged by Lead OS.</p>
                  <Button asChild variant="outline" size="sm" className="mt-2">
