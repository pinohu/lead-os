...
export default function TermsOfServicePage() {
  ...
  return (
    ...
    <main id="main-content" className="experience-page">
      ...
      <article style={{ maxWidth: "48rem", margin: "0 auto", padding: "2rem 1rem", lineHeight: 1.7 }}>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>3. Account Terms</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>4. Acceptable Use</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>5. Payment Terms</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>7. Data Processing</h2>
          <p>We process personal data in accordance with our <a href="/privacy" style={{ color: "#4f46e5", textDecoration: "underline" }}>Privacy Policy</a>. For business customers processing personal data of EU residents, we will enter into a Data Processing Agreement upon request. You are responsible for ensuring your use of the Service complies with applicable data protection laws, including obtaining necessary consents from individuals whose data you process through the Service.</p>
        </section>

        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>8. Service Level and Availability</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>9. Limitation of Liability</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>10. Indemnification</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>11. Termination</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>12. Dispute Resolution</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>13. Changes to Terms</h2>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.75rem" }}>14. Contact Information</h2>
          <p>For questions about these Terms, please contact us at <a href="mailto:legal@leadgen-os.com" style={{ color: "#4f46e5", textDecoration: "underline" }}>legal@leadgen-os.com</a> or visit our <a href="/contact" style={{ color: "#4f46e5", textDecoration: "underline" }}>contact page</a>.</p>
        </section>
      </article>
    </main>
    </>
