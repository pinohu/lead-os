...
export async function GET(request: Request) {
  ...
  try {
    ...
    logger.error("vista-social/posts GET failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
...
export async function POST(request: Request) {
  ...
  try {
    ...
    logger.error("vista-social/posts POST failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
