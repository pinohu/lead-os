...
export async function GET(
  ...
  try {
    ...
    console.error("[sendfox/campaigns/[id] GET]", err instanceof Error ? err.message : err);
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    console.error("[sendfox/campaigns/[id] POST]", err instanceof Error ? err.message : err);
