...
export async function POST(request: Request) {
  ...
  try {
    ...
    logger.error("flowlu/pipelines POST failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
...
export async function GET(request: Request) {
  ...
  try {
    ...
    logger.error("flowlu/pipelines GET failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
