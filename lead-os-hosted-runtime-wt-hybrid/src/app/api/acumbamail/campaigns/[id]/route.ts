...
export async function GET(
  ...
  try {
    ...
    console.error("[acumbamail/campaigns/[id] GET]", err instanceof Error ? err.message : err);
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    console.error("[acumbamail/campaigns/[id] POST]", err instanceof Error ? err.message : err);
