...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error("[acumbamail/campaigns GET]", err instanceof Error ? err.message : err);
    return NextResponse.json(
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("[acumbamail/campaigns POST]", err instanceof Error ? err.message : err);
    return NextResponse.json(
