...
export async function GET(request: Request) {
  ...
  try {
    ...
    logger.error("markopolo/audiences GET failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
...
export async function POST(request: Request) {
  ...
  try {
    ...
    logger.error("markopolo/audiences POST failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
