...
export async function GET(request: Request) {
  ...
  try {
    ...
    logger.error("reviews GET failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
...
export async function POST(request: Request) {
  ...
  try {
    ...
    logger.error("reviews POST failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
