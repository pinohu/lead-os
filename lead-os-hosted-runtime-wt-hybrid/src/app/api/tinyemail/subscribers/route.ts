...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error("[tinyemail/subscribers GET]", err instanceof Error ? err.message : err);
    return NextResponse.json(
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("[tinyemail/subscribers POST]", err instanceof Error ? err.message : err);
    return NextResponse.json(
