  ...
  return (
    <form className="panel auth-form" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-wrap gap-3 mt-4">
        <button type="submit" className="inline-flex min-h-11 items-center justify-center rounded-md bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-70 disabled:cursor-wait transition-colors" disabled={isPending}>
