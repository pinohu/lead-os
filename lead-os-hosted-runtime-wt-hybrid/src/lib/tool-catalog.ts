...
const TOOLS: ToolEntry[] = [
  ...
  // ─── OPEN-SOURCE TOOLS ────────────────────────────────────────────────────
  {
    ...
    name: "Cal.com",
    category: "booking",
    description: "Open-source scheduling platform. Self-hosted Calendly alternative with API-first design.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl"],
    leadOsMapping: "fulfillment",
    priority: "high",
    capabilities: ["scheduling", "booking-pages", "team-scheduling", "webhooks", "api-access"],
  },
  {
    slug: "formbricks",
    name: "Formbricks",
    category: "capture",
    description: "Open-source survey and form builder. Conversion-focused with targeting and segmentation.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl"],
    leadOsMapping: "capture",
    priority: "high",
    capabilities: ["forms", "surveys", "targeting", "segmentation", "webhooks"],
  },
  {
    slug: "posthog",
    name: "PostHog",
    ...
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "projectId", "baseUrl"],
    leadOsMapping: "analytics",
    priority: "high",
    capabilities: ["analytics", "session-replay", "feature-flags", "ab-testing", "funnels", "cohorts"],
  },
  {
    slug: "umami",
    name: "Umami",
    category: "tracking",
    description: "Privacy-first open-source web analytics. Lightweight Google Analytics alternative.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl", "websiteId"],
    leadOsMapping: "analytics",
    priority: "high",
    capabilities: ["web-analytics", "pageviews", "referrers", "device-tracking", "custom-events"],
  },
  {
    slug: "listmonk",
    name: "Listmonk",
    category: "communication",
    description: "High-performance open-source email marketing. Handles millions of emails. Go-based.",
    integrationMethod: "api",
    requiredCredentials: ["apiUrl", "username", "password"],
    leadOsMapping: "distribution",
    priority: "high",
    capabilities: ["email-campaigns", "subscriber-management", "templates", "analytics", "bounce-handling"],
  },
  {
    slug: "chatwoot",
    name: "Chatwoot",
    category: "communication",
    description: "Open-source omnichannel customer communication. Email, chat, social, WhatsApp in one.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl", "accountId"],
    leadOsMapping: "capture",
    priority: "high",
    capabilities: ["live-chat", "email", "whatsapp", "social-media", "chatbots", "canned-responses"],
  },
  {
    slug: "typebot",
    name: "Typebot",
    category: "capture",
    description: "Open-source conversational form and chatbot builder. Embeddable and self-hosted.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl"],
    leadOsMapping: "capture",
    priority: "high",
    capabilities: ["chatbots", "conversational-forms", "lead-qualification", "embeddable-widgets", "integrations"],
  },
  {
    slug: "mautic",
    name: "Mautic",
    category: "automation",
    description: "Open-source marketing automation. Email campaigns, lead scoring, landing pages, segments.",
    integrationMethod: "api",
    requiredCredentials: ["apiUrl", "clientId", "clientSecret"],
    leadOsMapping: "automation",
    priority: "high",
    capabilities: ["email-automation", "lead-scoring", "segmentation", "landing-pages", "campaigns", "tracking"],
  },
  {
    slug: "documenso",
    name: "Documenso",
    category: "capture",
    description: "Open-source document signing. Self-hosted DocuSign alternative with API.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl"],
    leadOsMapping: "fulfillment",
    priority: "high",
    capabilities: ["document-signing", "templates", "api-access", "webhooks"],
  },
  {
    slug: "payload-cms",
    name: "Payload CMS",
    category: "builders",
    description: "Headless CMS built with TypeScript and Next.js. Self-hosted with full API.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl"],
    leadOsMapping: "distribution",
    priority: "high",
    capabilities: ["headless-cms", "content-api", "media-management", "access-control", "webhooks"],
  },
  {
    slug: "serpbear",
    name: "Serpbear",
    category: "seo",
    description: "Open-source SEO rank tracking. Monitor keyword positions across search engines.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl"],
    leadOsMapping: "analytics",
    priority: "high",
    capabilities: ["rank-tracking", "keyword-monitoring", "serp-analysis", "notifications"],
  },
  {
    slug: "plane",
    name: "Plane",
    category: "automation",
    description: "Open-source project management. Linear/Jira alternative with cycles, modules, and views.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl", "workspaceSlug"],
    leadOsMapping: "automation",
    priority: "high",
    capabilities: ["issue-tracking", "project-management", "cycles", "modules", "api-access"],
  },
  {
    slug: "remotion",
    name: "Remotion",
    category: "content",
    description: "Programmable video framework for React. Generate MP4 videos from code. Free and unlimited.",
    integrationMethod: "embed",
    requiredCredentials: [],
    leadOsMapping: "creative",
    priority: "high",
    capabilities: ["video-generation", "motion-graphics", "data-visualization", "programmatic-video"],
  },
  {
    slug: "n8n-oss",
    name: "n8n",
    category: "automation",
    description: "Open-source workflow automation. 400+ integrations. Self-hosted Zapier alternative.",
    integrationMethod: "api",
    requiredCredentials: ["apiKey", "baseUrl"],
    leadOsMapping: "automation",
    priority: "critical",
    capabilities: ["workflow-automation", "integrations", "webhooks", "scheduling", "api-access"],
  },
