...
export const integrationMap = {
  ...
  reoon: integration(Boolean(process.env.REOON_API_KEY), "emailVerification"),
  databar: integration(Boolean(process.env.DATABAR_API_KEY), "enrichment"),
  chatbase: integration(Boolean(process.env.CHATBASE_API_KEY), "chat"),
  chargebee: integration(Boolean(process.env.CHARGEBEE_API_KEY && process.env.CHARGEBEE_SITE), "billing"),
  vistaSocial: integration(Boolean(process.env.VISTA_SOCIAL_API_KEY), "social"),
  leadrocks: integration(Boolean(process.env.LEADROCKS_API_KEY), "prospecting"),
  sendfox: integration(Boolean(process.env.SENDFOX_API_KEY), "email"),
  gmapsScraper: integration(Boolean(process.env.GMAPS_SCRAPER_API_KEY), "scraping"),
  clodura: integration(Boolean(process.env.CLODURA_API_KEY), "prospecting"),
  happierleads: integration(Boolean(process.env.HAPPIERLEADS_API_KEY), "identity"),
  salespanel: integration(Boolean(process.env.SALESPANEL_API_KEY), "scoring"),
  callscaler: integration(Boolean(process.env.CALLSCALER_API_KEY), "callTracking"),
  hexomatic: integration(Boolean(process.env.HEXOMATIC_API_KEY), "scraping"),
  moreGoodReviews: integration(Boolean(process.env.MORE_GOOD_REVIEWS_API_KEY), "reviews"),
  vbout: integration(Boolean(process.env.VBOUT_API_KEY), "marketingAutomation"),
  autobound: integration(Boolean(process.env.AUTOBOUND_API_KEY), "outreach"),
  flowlu: integration(Boolean(process.env.FLOWLU_API_KEY), "crm"),
  tinyemail: integration(Boolean(process.env.TINYEMAIL_API_KEY), "email"),
  acumbamail: integration(Boolean(process.env.ACUMBAMAIL_API_KEY), "email"),
  salesnexus: integration(Boolean(process.env.SALESNEXUS_API_KEY), "crm"),
  formaloo: integration(Boolean(process.env.FORMALOO_API_KEY), "forms"),
  plerdy: integration(Boolean(process.env.PLERDY_API_KEY), "cro"),
  novocall: integration(Boolean(process.env.NOVOCALL_API_KEY), "callback"),
  owox: integration(Boolean(process.env.OWOX_API_KEY), "attribution"),
  markopolo: integration(Boolean(process.env.MARKOPOLO_API_KEY), "adTargeting"),
  meiroCdp: integration(Boolean(process.env.MEIRO_API_KEY), "cdp"),
};
