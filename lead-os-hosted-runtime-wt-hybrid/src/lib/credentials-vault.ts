...
export const PROVIDER_CATALOG: ProviderDefinition[] = [
  ...
  { provider: "easy_text_marketing", category: "communication", fields: ["api_key"], enables: ["sms-sending"] },
  { provider: "insighto", category: "ai", fields: ["api_key", "bot_id"], enables: ["ai-chatbot"] },
  { provider: "thoughtly", category: "ai", fields: ["api_key"], enables: ["voice-agents"] },
  ...
  { provider: "brizy", category: "content", fields: ["api_key"], enables: ["page-builder"] },
  { provider: "claspo", category: "marketing", fields: ["api_key"], enables: ["popups-widgets"] },
