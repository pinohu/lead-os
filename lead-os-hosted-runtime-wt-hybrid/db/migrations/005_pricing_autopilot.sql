-- lead-os-hosted-runtime-wt-hybrid/db/migrations/005_pricing_autopilot.sql
...
CREATE TABLE IF NOT EXISTS pricing_outcome (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_pricing_outcome_due ON pricing_outcome(status, due_at);
