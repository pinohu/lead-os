...
export const TOOL_OWNERSHIP_MAP: Record<string, ToolOwnership> = {
  ...
  emailVerification: { primary: "Reoon", responsibility: "email verification and deliverability scoring" },
  enrichment: { primary: "Databar", responsibility: "contact and company data enrichment" },
  billing: { primary: "Chargebee", responsibility: "subscription billing, invoicing, and usage metering" },
  social: { primary: "Vista Social", responsibility: "social media scheduling and distribution" },
  prospecting: { primary: "LeadRocks", responsibility: "B2B contact search and enrichment", support: ["Clodura.AI"] },
  scraping: { primary: "Google Maps Scraper", responsibility: "business data scraping and ingestion", support: ["Hexomatic"] },
  callTracking: { primary: "CallScaler", responsibility: "call tracking, attribution, and lead conversion" },
  reviews: { primary: "More Good Reviews", responsibility: "review solicitation, management, and widgets" },
  marketingAutomation: { primary: "VBOUT", responsibility: "multi-channel marketing automation" },
  outreach: { primary: "Autobound", responsibility: "AI-personalized outreach sequences" },
  forms: { primary: "Formaloo", responsibility: "form-based lead capture and analytics" },
  callback: { primary: "Novocall", responsibility: "callback widgets and scheduling" },
  attribution: { primary: "OWOX BI", responsibility: "marketing attribution, ROAS, and funnel analysis" },
  adTargeting: { primary: "Markopolo.ai", responsibility: "AI ad targeting and audience sync" },
  cdp: { primary: "Meiro", responsibility: "customer data platform and identity resolution" },
};
