...
export async function POST(request: Request) {
  ...
  try {
    ...
    logger.error("owox/events POST failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
...
export async function GET(request: Request) {
  ...
  try {
    ...
    logger.error("owox/events GET failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
