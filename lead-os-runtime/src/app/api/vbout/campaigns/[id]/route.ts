...
export async function GET(
  ...
  try {
    ...
    logger.error("[vbout/campaigns/[id] GET]", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    logger.error("[vbout/campaigns/[id] POST]", { error: err instanceof Error ? err.message : String(err) });
