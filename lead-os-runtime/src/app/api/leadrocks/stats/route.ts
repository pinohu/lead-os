...
import { getSearchStats } from "@/lib/integrations/leadrocks-adapter";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    logger.error("leadrocks/stats GET failed", { error: err instanceof Error ? err.message : String(err) });
    return NextResponse.json(
